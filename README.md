...
Note that these constraints could be changed by given correspond options.
...
`E.g., 'abc/file.tex' and 'xyz/file.tex' shouldn't be in the same project`  
...
(Do not use *LaTeX*, use *Quick Build* instead)
